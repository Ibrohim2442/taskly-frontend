<template>
  <main class="flex-1 overflow-auto p-4 sm:p-6 bg-gray-50 min-h-screen">
    <div class="max-w-6xl mx-auto">
      ...
      <!-- Kanban (demo) -->
      <div v-if="boardsStore.activeBoardId" class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        <!-- To Do -->
        <div>
      ...
      <transition name="modal-premium">
        <div v-if="showBoardModal" class="fixed inset-0 flex items-center justify-center z-50">
          <div class="absolute inset-0 bg-black/30 backdrop-blur-md" @click.self="closeBoardModal"></div>
      ...
      <transition name="modal-premium">
        <div v-if="showDeleteModal" class="fixed inset-0 flex items-center justify-center z-50">
          <div class="absolute inset-0 bg-black/30 backdrop-blur-md" @click.self="closeDeleteModal"></div>
          <div class="relative w-full max-w-sm p-6 rounded-2xl bg-white border border-gray-200 shadow-xl">
            ...
            <p class="text-gray-600 mt-2">
              ...
              "<span class="font-medium">{{ selectedBoard?.name }}</span>"?
            </p>
...
<script setup>
  ...
  function openBoardModal(board = null) {
    ...
    Object.assign(boardForm, board || {id: null, name: '', description: '', project_id: activeProjectId.value})
